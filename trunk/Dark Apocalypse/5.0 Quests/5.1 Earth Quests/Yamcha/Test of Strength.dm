...
<table border=0 cellspacing=1 width=492 id=AutoNumber1 height=210>
  <tr>
    <td colspan=2 rowspan="4"><div align="center"><font face=Tahoma color=#FF0000><img src="http://img393.imageshack.us/img393/6834/yamcha6qv.jpg"></font></div></td>
  ...
  <tr>
    ...
    <td width=143 height=12><font face=Tahoma size=1>EXP +[round(usr.tnl / 2)]</font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan=4 height=48><font face=Tahoma size=1>Hey [usr.name]! It's good
      ...
      good measure up of your skills so far. I want you to o out and kill 5 Green Saibamen.
      They shouldn't be a probem, right?</font></td>
  </tr>
</table>
"}
